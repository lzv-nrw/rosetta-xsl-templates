...
<xsl:stylesheet
	...
	<xsl:template match="//mets:mets">
		<mets:mets xmlns:mets="http://www.loc.gov/METS/">
			...
			<xsl:apply-templates select="mets:fileSec"
				mode="rep" />
			<xsl:apply-templates
				select="mets:dmdSec/mets:mdWrap[@MDTYPE=&apos;MODS&apos;]/mets:xmlData"
				mode="ie" />
			<xsl:apply-templates
	...
	<xsl:template match="mods:mods" mode="ie">
				...
				<mets:mdWrap MDTYPE="OTHER" OTHERMDTYPE="xml">
					<mets:xmlData>
						<record>
							...
							<!-- <xsl:copy-of select="document(string(concat($source_path,substring-after($oai_id,&apos;uni-koeln.de:&apos;),&apos;/&apos;,translate(substring-after($oai_id,&apos;uni-koeln.de:&apos;),&apos;/&apos;,&apos;-&apos;),&apos;_metadata&apos;,&apos;.xml&apos;)))" 
								/> -->
